...
import vbonedra.mob_dismemberment.model.ModelGibBlaze;
...
public class RenderGibBlaze extends RenderGibBase {
    public RenderGibBlaze() {
        super(new ModelGibBlaze(), new ResourceLocation("textures/entity/blaze.png"));
    }
    @Override
