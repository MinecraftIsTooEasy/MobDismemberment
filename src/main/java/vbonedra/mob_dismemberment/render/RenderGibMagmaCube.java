...
import vbonedra.mob_dismemberment.model.ModelGibMagmaCube;
...
public class RenderGibMagmaCube extends RenderGibBase {
    public RenderGibMagmaCube() {
        super(new ModelGibMagmaCube(), new ResourceLocation("textures/entity/slime/magmacube.png"));
    }
    ...
    public void doRender(Entity ent, double par2, double par4, double par6, float par8, float par9) {
        ...
        if (isCore) {
            ...
            int var6 = lightCoords % 65536;
            int var7 = lightCoords / 65536;
