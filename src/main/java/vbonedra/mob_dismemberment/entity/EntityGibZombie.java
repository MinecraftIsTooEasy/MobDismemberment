...
public class EntityGibZombie extends EntityGibBase {
    public EntityGibZombie(World world) {
        super(world);
    }

    public EntityGibZombie(World world, EntityLivingBase gibParent, int gibType, Entity explosion_source) {
